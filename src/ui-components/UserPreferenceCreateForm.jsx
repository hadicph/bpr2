...
export default function UserPreferenceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new UserPreference(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "UserPreferenceCreateForm")}
      {...rest}
    >
      <TextField
        label="Owner"
