...
export default function RouteUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = routeRecord
      ...
      : initialValues;
    setRoute_name(cleanValues.route_name);
    setStatus(cleanValues.status);
    setDate(cleanValues.date);
    setOptimized(cleanValues.optimized);
    setHasStarted(cleanValues.hasStarted);
    setEstimated_time(cleanValues.estimated_time);
    setEstimated_distance(cleanValues.estimated_distance);
